    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 mb-4 mb-lg-0">
            ...
            <div class="form-group">
              ...
              <div class="form-check ml-3">
                <div class="custom-control mb-2 custom-radio d-inline-block col-md-4">
                  <input type="radio" id="customRadio1" name="default_key" class="custom-control-input" value="online">
                ...
                <div class="custom-control mb-4 custom-radio d-inline-block col-md-4">
                  <input type="radio" id="customRadio2" name="default_key" class="custom-control-input" value="local" checked>
                  <label class="custom-control-label" for="customRadio2">Local</label>
                </div>
              </div>
            </div>
        ...
        <div class="clearfix"></div>
          ...
          <a href="<?php echo base_url('admin/course'); ?>" class="btn mb-2 btn-sm flat btn-dark py-1 px-1 float-right mr-1"><span class="material-icons align-top md-18 mr-1">arrow_left</span>Back&nbsp;</a>
          <?php echo form_close(); ?>
        </div>
      </div>
    </div>
