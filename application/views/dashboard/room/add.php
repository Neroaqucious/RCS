    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 mb-4 mb-lg-0">
        ...
        <div class="col-lg-6 col-md-6 float-left">
          ...
          <div class="form-group">
            <?php
              echo form_label('Description','description', array('class' => 'col-form-label'));
            ?>
          ...
          <div class="form-group">
            ...
            <div class="custom-control mb-4 custom-radio d-inline-block col-md-2">
              <input type="radio" id="customRadio2" name="status" class="custom-control-input" value="0" checked>
          ...
          <button button type="submit" class="btn mb-2 btn-sm flat btn-dark py-1 px-1 float-right"><span class="material-icons align-top md-18 mr-1">add_circle</span>Submit&nbsp;</button>
