    ...
    <div class="card-body">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-left">
            <a href="<?php echo base_url('admin/local/view/'.$row->id); ?>">
              <?php echo $row->name; ?>
            </a>
          </td>
          ...
          <td class="text-center">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
              <a class="dropdown-item" href="<?php echo base_url('admin/local/edit/'.$row->id); ?>">Edit</a>
              <a onclick="return confirm('Are you want to delete this data?');"  class="dropdown-item" href="<?php echo base_url('admin/local/delete/'.$row->id); ?>">Delete</a>
            </div>
          </td>
        </tr>
        <?php $x++; } ?>
