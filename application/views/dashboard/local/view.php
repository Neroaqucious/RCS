      ...
      <div class="col-lg-12">
        ...
        <div class="col-md-12 mt-3">
          ...
          <div class="col-md-7 p-0 float-left">  
            ...
            <p>
              <span class="text-dark weight-300" style="width:130px; display:inline-block;">Company Name</span>
              <span><?php echo $result->name; ?></span>
            </p>
            <p>
              <span class="text-dark weight-300" style="width:130px; display:inline-block;">Company Email</span>
              <span><?php echo $result->email; ?></span>
            </p>
            <p>
              <span class="text-dark weight-300" style="width:130px; display:inline-block;">Company Phone</span>
        ...
        <hr class="my-4 dashed clearfix">                
          <a href="<?php echo base_url('admin/local/edit/'.$result->id); ?>" class="btn mb-2 btn-sm flat btn-dark py-1 px-1 float-right ml-2" ><span class="material-icons align-text-bottom">edit</span></a>
          <a href="<?php echo base_url('admin/local'); ?>" class="btn mb-2 btn-sm flat btn-dark py-1 px-1 float-right" ><span class="material-icons align-text-bottom">keyboard_backspace</span></a>
      </div>
    </div>
  </div>
</div>
