      ...
      <div class="card mb-4">
        <div class="card-body">
          <?php
            ...
            echo form_open_multipart('admin/school/edit/'.$result->id, $attributes);
          ?>
          <div class="col-lg-12 col-md-12 float-left">
            <div class="col-lg-7 float-left">
              ...
              <div class="form-group">
                ...
                <textarea name="requirement" cols="" rows="6" placeholder="Enter requirement" class="form-control">
                  <?php echo html_escape(set_value('requirement',isset($result)?$result->requirement:''), ENT_NOQUOTES); ?>
                </textarea>
              ...
              <div class="form-group">
                ...
                echo form_dropdown(
                  'tags',  //dropdown name
                  $respond['tags'],
                  set_value('tags',isset($result)?$result->tag_id:''),
                  $setarray
                );
                ?>
              ...
              <?php
                if(isset($result->photo)){
                  echo '<img src="'.base_url().'/upload/assets/adm/new/'.$result->photo.'" width="100">';
                } ?>
              <div class="form-group">
                <?php echo form_label('School Image', 'userfile',  array( 'class' => '', 'id' => '', 'style' => 'margin-bottom:10px')); ?>
            ...
            <div class="col-lg-5 float-right">
              <div class="form-group">
                <?php echo form_label('School Name', 'name', array( 'class' => '', 'id'=> '', 'style' => 'margin-bottom:10px')); ?>
                <span class="badge badge-danger">Required</span>
                <?php
                  echo form_input(array(
                  'name' => 'name',
              ...
              <div class="form-group">
                <?php echo form_label('School Email', 'email', array( 'class' => '', 'id'=> '', 'style' => 'margin-bottom:10px')); ?>
                <?php
                  echo form_input(array(
                  'name' => 'email',
                  'type' => 'text',
              ...
              <div class="form-group">
                <?php
                  echo form_label('School Address','address', array('class' => 'col-form-label'));
                ?>
                <span class="badge badge-danger">Required</span>
                <div class="col-md-12 col-sm-12 p-0">
                  <?php 
        ...
        <hr class="my-4 dashed clearfix">
          ...
          <a href="<?php echo base_url('admin/school'); ?>" class="btn mb-2 btn-sm flat btn-dark py-1 px-1 float-right mr-1"><span class="material-icons align-top md-18 mr-1">arrow_left</span>Back&nbsp;</a>
        <?php echo form_close(); ?>
        </div>
      </div>
    </div>
