    ...
    <div class="table-responsive">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-left"><a href="<?php echo base_url('admin/instructor/view/'.$row->id); ?>" class="text-dark"><?php echo $row->name; ?></a></td>            
          <td class="text-left"><?php echo $row->email; ?></td>   
          <td class="text-left"><?php echo $row->phone; ?></td>   
          <td class="text-left"><?php echo $row->lecture; ?></td>   
          ...
          <td class="text-center">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
                <a class="dropdown-item" href="<?php echo base_url('admin/instructor/edit/'.$row->id); ?>">Edit</a>
                <a onclick="return confirm('Are you want to delete this data?');"  class="dropdown-item" href="<?php echo base_url('admin/instructor/delete/'.$row->id); ?>">Delete</a>
              </div>
          </td>
        </tr>
        <?php $x++; } ?>
